...
if (run_analysis)
    ...
    parfor k = 1:2000
        cn_full_XMat = [cn_full_fdg_bl_avgMat(:,k) cn_full_av45_bl_avgMat(:,k) cn_age_data cn_gender_data cn_apoe4_data];
    ...
    parfor k = 1:2000
        emci_full_XMat = [emci_full_fdg_bl_avgMat(:,k) emci_full_av45_bl_avgMat(:,k) emci_age_data emci_gender_data emci_apoe4_data];
    ...
    parfor k = 1:2000
        lmci_full_XMat = [lmci_full_fdg_bl_avgMat(:,k) lmci_full_av45_bl_avgMat(:,k) lmci_age_data lmci_gender_data lmci_apoe4_data];
    ...
    parfor k = 1:2000
        ad_full_XMat = [ad_full_fdg_bl_avgMat(:,k) ad_full_av45_bl_avgMat(:,k) ad_age_data ad_gender_data ad_apoe4_data];
...
if (run_writeStats)
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'blFDG' , 'blAV45' , 'age' , 'gender' , 'apoe4'}
          s_e = strcat('writeToFile(',i,'_full_lm_',j,'_e_list_fdr, ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_pvcd/',i,'_lm_',j,'_fdr_e_l.txt'', ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_pvcd/',i,'_lm_',j,'_fdr_e_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_e{1,1});
       end
    end
    ...
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'blFDG' , 'blAV45' , 'age' , 'gender' , 'apoe4'}
          s_t = strcat('writeToFile(',i,'_full_lm_',j,'_t_list_fdr, ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_pvcd/',i,'_lm_',j,'_fdr_t_l.txt'', ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_pvcd/',i,'_lm_',j,'_fdr_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t{1,1});
       end
    end
    ...
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'blFDG' , 'blAV45' , 'age' , 'gender' , 'apoe4'}
          s_t_f = strcat('writeToFile(',i,'_full_lm_',j,'_t_list, ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_pvcd/',i,'_lm_',j,'_full_t_l.txt'', ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_pvcd/',i,'_lm_',j,'_full_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t_f{1,1});
       end
    end
end
