...
if (run_cn)
    ...
    cn_av45_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/cn_av45_bl_globalSUVR.csv';
    cn_av45_bl_d = textscan(fopen(cn_av45_bl_file), '%d,%f');
    cn_av45_bl_data = cn_av45_bl_d{1,2};
    
    cn_av45_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/cn_av45_fu_globalSUVR.csv';
    cn_av45_fu_d = textscan(fopen(cn_av45_fu_file), '%d,%f');
    cn_av45_fu_data = cn_av45_fu_d{1,2};
    
    cn_fdg_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/cn_fdg_bl_globalSUVR.csv';
    cn_fdg_bl_d = textscan(fopen(cn_fdg_bl_file), '%d,%f');
    cn_fdg_bl_data = cn_fdg_bl_d{1,2};
    
    cn_fdg_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/cn_fdg_fu_globalSUVR.csv';
...
if (run_emci)
    ...
    emci_av45_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/emci_av45_bl_globalSUVR.csv';
    emci_av45_bl_d = textscan(fopen(emci_av45_bl_file), '%d,%f');
    emci_av45_bl_data = emci_av45_bl_d{1,2};
    
    emci_av45_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/emci_av45_fu_globalSUVR.csv';
    emci_av45_fu_d = textscan(fopen(emci_av45_fu_file), '%d,%f');
    emci_av45_fu_data = emci_av45_fu_d{1,2};
    
    emci_fdg_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/emci_fdg_bl_globalSUVR.csv';
    emci_fdg_bl_d = textscan(fopen(emci_fdg_bl_file), '%d,%f');
    emci_fdg_bl_data = emci_fdg_bl_d{1,2};
    
    emci_fdg_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/emci_fdg_fu_globalSUVR.csv';
...
if (run_lmci)
    ...
    lmci_av45_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/lmci_av45_bl_globalSUVR.csv';
    lmci_av45_bl_d = textscan(fopen(lmci_av45_bl_file), '%d,%f');
    lmci_av45_bl_data = lmci_av45_bl_d{1,2};
    
    lmci_av45_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/lmci_av45_fu_globalSUVR.csv';
    lmci_av45_fu_d = textscan(fopen(lmci_av45_fu_file), '%d,%f');
    lmci_av45_fu_data = lmci_av45_fu_d{1,2};
    
    lmci_fdg_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/lmci_fdg_bl_globalSUVR.csv';
    lmci_fdg_bl_d = textscan(fopen(lmci_fdg_bl_file), '%d,%f');
    lmci_fdg_bl_data = lmci_fdg_bl_d{1,2};
    
    lmci_fdg_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/lmci_fdg_fu_globalSUVR.csv';
...
if (run_ad)
    ...
    ad_av45_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/ad_av45_bl_globalSUVR.csv';
    ad_av45_bl_d = textscan(fopen(ad_av45_bl_file), '%d,%f');
    ad_av45_bl_data = ad_av45_bl_d{1,2};
    
    ad_av45_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/ad_av45_fu_globalSUVR.csv';
    ad_av45_fu_d = textscan(fopen(ad_av45_fu_file), '%d,%f');
    ad_av45_fu_data = ad_av45_fu_d{1,2};
    
    ad_fdg_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/ad_fdg_bl_globalSUVR.csv';
    ad_fdg_bl_d = textscan(fopen(ad_fdg_bl_file), '%d,%f');
    ad_fdg_bl_data = ad_fdg_bl_d{1,2};
    
    ad_fdg_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/ad_fdg_fu_globalSUVR.csv';
...
if (run_analysis)
    ...
    parfor k = 1:2000
        cn_full_XMat = [cn_fdg_bl_data cn_av45_bl_data cn_age_data cn_gender_data cn_apoe4_data cn_visitDdiffFDG_data];
    ...
    parfor k = 1:2000
        emci_full_XMat = [emci_fdg_bl_data emci_av45_bl_data emci_age_data emci_gender_data emci_apoe4_data emci_visitDdiffFDG_data];
    ...
    parfor k = 1:2000
        lmci_full_XMat = [lmci_fdg_bl_data lmci_av45_bl_data lmci_age_data lmci_gender_data lmci_apoe4_data lmci_visitDdiffFDG_data];
    ...
    parfor k = 1:2000
        ad_full_XMat = [ad_fdg_bl_data ad_av45_bl_data ad_age_data ad_gender_data ad_apoe4_data ad_visitDdiffFDG_data];
...
if (run_writeStats)
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'blFDG' , 'blAV45' , 'age' , 'gender' , 'apoe4' , 'visitDdiffFDG'}
          s_e = strcat('writeToFile(',i,'_full_lm_',j,'_e_list_fdr, ''/home/sulantha/Desktop/linear_model_sept2014/Wo_Int_fuFDG_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_fdr_e_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Wo_Int_fuFDG_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_fdr_e_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_e{1,1});
       end
    end
    ...
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'blFDG' , 'blAV45' , 'age' , 'gender' , 'apoe4' , 'visitDdiffFDG'}
          s_t = strcat('writeToFile(',i,'_full_lm_',j,'_t_list_fdr, ''/home/sulantha/Desktop/linear_model_sept2014/Wo_Int_fuFDG_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_fdr_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Wo_Int_fuFDG_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_fdr_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t{1,1});
       end
    end
    ...
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'blFDG' , 'blAV45' , 'age' , 'gender' , 'apoe4' , 'visitDdiffFDG'}
          s_t_f = strcat('writeToFile(',i,'_full_lm_',j,'_t_list, ''/home/sulantha/Desktop/linear_model_sept2014/Wo_Int_fuFDG_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_full_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Wo_Int_fuFDG_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_full_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t_f{1,1});
       end
    end
end
