...
if (gen_data_tables)
    ...
    total_subjects = cn_size + ad_size;
    
    age_vec = [cn_age_data; ad_age_data];
    gender_vec = [cn_gender_data; ad_gender_data];
    apoe4_vec = [cn_apoe4_data; ad_apoe4_data];
    diagnosis_vector = [ones(cn_size,1)*0; ones(ad_size,1)*1];
    
    fdg_bl_matrix = [cn_full_fdg_bl_avgMat; ad_full_fdg_bl_avgMat];
    fdg_fu_matrix = [cn_full_fdg_fu_avgMat; ad_full_fdg_fu_avgMat];
    av45_bl_matrix = [cn_full_av45_bl_avgMat; ad_full_av45_bl_avgMat];
    fdg_hypo_matrix = [cn_full_fdg_Yearlyhypomet; ad_full_fdg_Yearlyhypomet];
    av45_amy_matrix = [cn_full_av45_Yearlyamyloidosis; ad_full_av45_Yearlyamyloidosis];
...
if (run_writeStats)
    for i = {'blAV45', 'adblAV45'}
          ...
          s_e = strcat('writeToFile(eVals_',i,'_fdr'', ''/data/data03/sulantha/linear_model_feb2015/Int_diagnosis_Hypo_diffBlur_noAmyloidosis_CNvsAD/',i,'_lm_fdr_e_l.txt'', ''/data/data03/sulantha/linear_model_feb2015/Int_diagnosis_Hypo_diffBlur_noAmyloidosis_CNvsAD/',i,'_lm_fdr_e_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_e{1,1});
    ...
    for i = {'blAV45', 'adblAV45'}
          ...
          s_t = strcat('writeToFile(tVals_',i,'_fdr'', ''/data/data03/sulantha/linear_model_feb2015/Int_diagnosis_Hypo_diffBlur_noAmyloidosis_CNvsAD/',i,'_lm_fdr_t_l.txt'', ''/data/data03/sulantha/linear_model_feb2015/Int_diagnosis_Hypo_diffBlur_noAmyloidosis_CNvsAD/',i,'_lm_fdr_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t{1,1});
    ...
    for i = {'blAV45', 'adblAV45'}
          ...
          s_t_f = strcat('writeToFile(tVals_',i,''', ''/data/data03/sulantha/linear_model_feb2015/Int_diagnosis_Hypo_diffBlur_noAmyloidosis_CNvsAD/',i,'_lm_full_t_l.txt'', ''/data/data03/sulantha/linear_model_feb2015/Int_diagnosis_Hypo_diffBlur_noAmyloidosis_CNvsAD/',i,'_lm_full_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t_f{1,1});
