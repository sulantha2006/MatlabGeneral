...
if (run_analysis)
    ...
    cn_full_lm_amyloidosisInterblFDG_p_list = zeros(1,2000);
    ...
    cn_full_lm_amyloidosisInterblFDG_t_list = zeros(1,2000);
    ...
    cn_full_lm_amyloidosisInterblFDG_e_list = zeros(1,2000);
    cn_full_lm_age_e_list = zeros(1,2000);
    cn_full_lm_gender_e_list = zeros(1,2000);
    cn_full_lm_apoe4_e_list = zeros(1,2000);

    for k = 1:2000
        cn_full_XMat = [cn_full_av45_amylodosis(:,k) cn_full_fdg_bl_avgMat(:,k) cn_full_av45_bl_avgMat(:,k) cn_full_av45_amylodosis(:,k).*cn_full_fdg_bl_avgMat(:,k) cn_age_data cn_gender_data cn_apoe4_data];
        ...
        cn_full_lm_amyloidosisInterblFDG_p_list(k) = cn_full_lm.Coefficients.pValue(5);
        ...
        cn_full_lm_amyloidosisInterblFDG_t_list(k) = cn_full_lm.Coefficients.tStat(5);
        ...
        cn_full_lm_amyloidosisInterblFDG_e_list(k) = cn_full_lm.Coefficients.Estimate(5);
    ...
    emci_full_lm_amyloidosisInterblFDG_p_list = zeros(1,2000);
    ...
    emci_full_lm_amyloidosisInterblFDG_t_list = zeros(1,2000);
    ...
    emci_full_lm_amyloidosisInterblFDG_e_list = zeros(1,2000);
    emci_full_lm_age_e_list = zeros(1,2000);
    emci_full_lm_gender_e_list = zeros(1,2000);
    emci_full_lm_apoe4_e_list = zeros(1,2000);

    for k = 1:2000
        emci_full_XMat = [emci_full_av45_amylodosis(:,k) emci_full_fdg_bl_avgMat(:,k) emci_full_av45_bl_avgMat(:,k) emci_full_av45_amylodosis(:,k).*emci_full_fdg_bl_avgMat(:,k) emci_age_data emci_gender_data emci_apoe4_data];
        ...
        emci_full_lm_amyloidosisInterblFDG_p_list(k) = emci_full_lm.Coefficients.pValue(5);
        ...
        emci_full_lm_amyloidosisInterblFDG_t_list(k) = emci_full_lm.Coefficients.tStat(5);
        ...
        emci_full_lm_amyloidosisInterblFDG_e_list(k) = emci_full_lm.Coefficients.Estimate(5);
    ...
    lmci_full_lm_amyloidosisInterblFDG_p_list = zeros(1,2000);
    ...
    lmci_full_lm_amyloidosisInterblFDG_t_list = zeros(1,2000);
    ...
    lmci_full_lm_amyloidosisInterblFDG_e_list = zeros(1,2000);
    lmci_full_lm_age_e_list = zeros(1,2000);
    lmci_full_lm_gender_e_list = zeros(1,2000);
    lmci_full_lm_apoe4_e_list = zeros(1,2000);

    for k = 1:2000
        lmci_full_XMat = [lmci_full_av45_amylodosis(:,k) lmci_full_fdg_bl_avgMat(:,k) lmci_full_av45_bl_avgMat(:,k) lmci_full_av45_amylodosis(:,k).*lmci_full_fdg_bl_avgMat(:,k) lmci_age_data lmci_gender_data lmci_apoe4_data];
        ...
        lmci_full_lm_amyloidosisInterblFDG_p_list(k) = lmci_full_lm.Coefficients.pValue(5);
        ...
        lmci_full_lm_amyloidosisInterblFDG_t_list(k) = lmci_full_lm.Coefficients.tStat(5);
        ...
        lmci_full_lm_amyloidosisInterblFDG_e_list(k) = lmci_full_lm.Coefficients.Estimate(5);
    ...
    ad_full_lm_amyloidosisInterblFDG_p_list = zeros(1,2000);
    ...
    ad_full_lm_amyloidosisInterblFDG_t_list = zeros(1,2000);
    ...
    ad_full_lm_amyloidosisInterblFDG_e_list = zeros(1,2000);
    ad_full_lm_age_e_list = zeros(1,2000);
    ad_full_lm_gender_e_list = zeros(1,2000);
    ad_full_lm_apoe4_e_list = zeros(1,2000);

    for k = 1:2000
        ad_full_XMat = [ad_full_av45_amylodosis(:,k) ad_full_fdg_bl_avgMat(:,k) ad_full_av45_bl_avgMat(:,k) ad_full_av45_amylodosis(:,k).*ad_full_fdg_bl_avgMat(:,k) ad_age_data ad_gender_data ad_apoe4_data];
        ...
        ad_full_lm_amyloidosisInterblFDG_p_list(k) = ad_full_lm.Coefficients.pValue(5);
        ...
        ad_full_lm_amyloidosisInterblFDG_t_list(k) = ad_full_lm.Coefficients.tStat(5);
        ...
        ad_full_lm_amyloidosisInterblFDG_e_list(k) = ad_full_lm.Coefficients.Estimate(5);
...
if (run_fdr)
    ...
    amyloidosisInterblFDG_p_list = [cn_full_lm_amyloidosisInterblFDG_p_list; emci_full_lm_amyloidosisInterblFDG_p_list; lmci_full_lm_amyloidosisInterblFDG_p_list; ad_full_lm_amyloidosisInterblFDG_p_list];
    ...
    amyloidosisInterblFDG_p_list_fdr = fdr_bh(amyloidosisInterblFDG_p_list, 0.1);
...
if (get_estimates)
    ...
    cn_full_lm_amyloidosisInterblFDG_e_list_fdr = cn_full_lm_amyloidosisInterblFDG_e_list .* amyloidosisInterblFDG_p_list_fdr(1,:);
    emci_full_lm_amyloidosisInterblFDG_e_list_fdr = emci_full_lm_amyloidosisInterblFDG_e_list .* amyloidosisInterblFDG_p_list_fdr(2,:);
    lmci_full_lm_amyloidosisInterblFDG_e_list_fdr = lmci_full_lm_amyloidosisInterblFDG_e_list .* amyloidosisInterblFDG_p_list_fdr(3,:);
    ad_full_lm_amyloidosisInterblFDG_e_list_fdr = ad_full_lm_amyloidosisInterblFDG_e_list .* amyloidosisInterblFDG_p_list_fdr(4,:);
...
if (get_tstats_fdr)
    ...
    cn_full_lm_amyloidosisInterblFDG_t_list_fdr = cn_full_lm_amyloidosisInterblFDG_t_list .* amyloidosisInterblFDG_p_list_fdr(1,:);
    emci_full_lm_amyloidosisInterblFDG_t_list_fdr = emci_full_lm_amyloidosisInterblFDG_t_list .* amyloidosisInterblFDG_p_list_fdr(2,:);
    lmci_full_lm_amyloidosisInterblFDG_t_list_fdr = lmci_full_lm_amyloidosisInterblFDG_t_list .* amyloidosisInterblFDG_p_list_fdr(3,:);
    ad_full_lm_amyloidosisInterblFDG_t_list_fdr = ad_full_lm_amyloidosisInterblFDG_t_list .* amyloidosisInterblFDG_p_list_fdr(4,:);
...
if (run_writeStats)
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'amyloidosis' , 'blFDG' , 'blAV45' , 'amyloidosisInterblFDG', 'age' , 'gender' , 'apoe4'}
          s_e = strcat('writeToFile(',i,'_full_lm_',j,'_e_list_fdr, ''/home/sulantha/Desktop/linear_model_sept2014/',i,'_lm_',j,'_fdr_e_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/',i,'_lm_',j,'_fdr_e_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_e{1,1});
       end
    end
    ...
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'amyloidosis' , 'blFDG' , 'blAV45' , 'amyloidosisInterblFDG', 'age' , 'gender' , 'apoe4'}
          s_t = strcat('writeToFile(',i,'_full_lm_',j,'_t_list_fdr, ''/home/sulantha/Desktop/linear_model_sept2014/',i,'_lm_',j,'_fdr_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/',i,'_lm_',j,'_fdr_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t{1,1});
       end
    end
    ...
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'amyloidosis' , 'blFDG' , 'blAV45' , 'amyloidosisInterblFDG', 'age' , 'gender' , 'apoe4'}
          s_t_f = strcat('writeToFile(',i,'_full_lm_',j,'_t_list, ''/home/sulantha/Desktop/linear_model_sept2014/',i,'_lm_',j,'_full_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/',i,'_lm_',j,'_full_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t_f{1,1});
       end
    end
end