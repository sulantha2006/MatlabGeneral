...
if (run_analysis)
    ...
    for k = 1:2000
        ...
        cn_full_lm = LinearModel.fit(cn_full_XMat, cn_full_fdg_fu_avgMat(:,k), 'CategoricalVars', [6,7]);
    ...
    for k = 1:2000
        ...
        emci_full_lm = LinearModel.fit(emci_full_XMat, emci_full_fdg_fu_avgMat(:,k), 'CategoricalVars', [6,7]);
    ...
    for k = 1:2000
        ...
        lmci_full_lm = LinearModel.fit(lmci_full_XMat, lmci_full_fdg_fu_avgMat(:,k), 'CategoricalVars', [6,7]);
    ...
    for k = 1:2000
        ...
        ad_full_lm = LinearModel.fit(ad_full_XMat, ad_full_fdg_fu_avgMat(:,k), 'CategoricalVars', [6,7]);
...
if (run_writeStats)
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'amyloidosis' , 'blFDG' , 'blAV45' , 'blAv45InterblFDG', 'age' , 'gender' , 'apoe4'}
          s_e = strcat('writeToFile(',i,'_full_lm_',j,'_e_list_fdr, ''/home/sulantha/Desktop/linear_model_sept2014/Int_blAV_blFD_fuFDG/',i,'_lm_',j,'_fdr_e_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_blAV_blFD_fuFDG/',i,'_lm_',j,'_fdr_e_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_e{1,1});
       end
    end
    ...
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'amyloidosis' , 'blFDG' , 'blAV45' , 'blAv45InterblFDG', 'age' , 'gender' , 'apoe4'}
          s_t = strcat('writeToFile(',i,'_full_lm_',j,'_t_list_fdr, ''/home/sulantha/Desktop/linear_model_sept2014/Int_blAV_blFD_fuFDG/',i,'_lm_',j,'_fdr_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_blAV_blFD_fuFDG/',i,'_lm_',j,'_fdr_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t{1,1});
       end
    end
    ...
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'amyloidosis' , 'blFDG' , 'blAV45' , 'blAv45InterblFDG', 'age' , 'gender' , 'apoe4'}
          s_t_f = strcat('writeToFile(',i,'_full_lm_',j,'_t_list, ''/home/sulantha/Desktop/linear_model_sept2014/Int_blAV_blFD_fuFDG/',i,'_lm_',j,'_full_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_blAV_blFD_fuFDG/',i,'_lm_',j,'_full_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t_f{1,1});
       end
    end
end
