...
if (gen_data_tables)
    ...
    fdg_bl_matrix = [cn_full_fdg_bl_avgMat; emci_full_fdg_bl_avgMat; lmci_full_fdg_bl_avgMat; ad_full_fdg_bl_avgMat];
    fdg_fu_matrix = [cn_full_fdg_fu_avgMat; emci_full_fdg_fu_avgMat; lmci_full_fdg_fu_avgMat; ad_full_fdg_fu_avgMat];
    av45_bl_matrix = [cn_full_av45_bl_avgMat; emci_full_av45_bl_avgMat; lmci_full_av45_bl_avgMat; ad_full_av45_bl_avgMat];
    fdg_hypo_matrix = [cn_full_fdg_Yearlyhypomet; emci_full_fdg_Yearlyhypomet; lmci_full_fdg_Yearlyhypomet; ad_full_fdg_Yearlyhypomet];
    av45_amy_matrix = [cn_full_av45_Yearlyamyloidosis; emci_full_av45_Yearlyamyloidosis; lmci_full_av45_Yearlyamyloidosis; ad_full_av45_Yearlyamyloidosis];
        
end

if (run_analysis) 
    main_table = table(age_vec, nominal(gender_vec), nominal(apoe4_vec), nominal(diagnosis_vector), zeros(total_subjects, 1), zeros(total_subjects, 1) ,zeros(total_subjects, 1), zeros(total_subjects, 1), 'VariableNames', {'age','gender','apoe4','diagnosis', 'blFDG','blAV45','fuFDG','yearlyAmy'});
    ...
    parfor k=1:2000
        ...
        for_table.fuFDG = fdg_fu_matrix(:,k);
        
        lm = fitlm(for_table, 'fuFDG ~ diagnosis*blAV45 + age + gender + apoe4 + blFDG');
        
        pVals_blAV45(k) = lm.Coefficients.pValue(9);
    
        pVals_emciblAV45(k) = lm.Coefficients.pValue(10);
        pVals_lmciblAV45(k) = lm.Coefficients.pValue(11);
        pVals_adblAV45(k) = lm.Coefficients.pValue(12);
            
        eVals_blAV45(k) = lm.Coefficients.Estimate(9);
    
        eVals_emciblAV45(k) = lm.Coefficients.Estimate(10);
        eVals_lmciblAV45(k) = lm.Coefficients.Estimate(11);
        eVals_adblAV45(k) = lm.Coefficients.Estimate(12);
            
        tVals_blAV45(k) = lm.Coefficients.tStat(9);
    
        tVals_emciblAV45(k) = lm.Coefficients.tStat(10);
        tVals_lmciblAV45(k) = lm.Coefficients.tStat(11);
        tVals_adblAV45(k) = lm.Coefficients.tStat(12);
...
if (run_writeStats)
    for i = {'blAV45', 'emciblAV45', 'lmciblAV45', 'adblAV45'}
       
          s_e = strcat('writeToFile(eVals_',i,'_fdr'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_fuFDG_diffBlur_noAmyloidosis/',i,'_lm_fdr_e_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_fuFDG_diffBlur_noAmyloidosis/',i,'_lm_fdr_e_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_e{1,1});
    ...
    for i = {'blAV45', 'emciblAV45', 'lmciblAV45', 'adblAV45'}
          ...
          s_t = strcat('writeToFile(tVals_',i,'_fdr'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_fuFDG_diffBlur_noAmyloidosis/',i,'_lm_fdr_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_fuFDG_diffBlur_noAmyloidosis/',i,'_lm_fdr_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t{1,1});
    ...
    for i = {'blAV45', 'emciblAV45', 'lmciblAV45', 'adblAV45'}
          ...
          s_t_f = strcat('writeToFile(tVals_',i,''', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_fuFDG_diffBlur_noAmyloidosis/',i,'_lm_full_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_fuFDG_diffBlur_noAmyloidosis/',i,'_lm_full_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t_f{1,1});
