function [ LMO ] = performLinearModel( inputTable, stringModel, multivalueVariables, multiValueSize, doVertexReduction, categoricalVars, includeString )
...
%             end
            lm = parForLM(f_h, stringModel, k, categoricalVars, multivalueVariables, multiVarMap);
...
function [model] = parForLM(table, formula, k, categoricalVars, multivalueVariables, multiVarMap)
        for varName = multivalueVariables
