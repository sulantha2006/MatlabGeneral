...
if (run_writeStats)
    for i = {'blAV45', 'emciblAV45', 'lmciblAV45', 'adblAV45'}
          ...
          s_e = strcat('writeToFile(eVals_',i,'_fdr'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_Hypo_diffBlur_noAmyloidosis/',i,'_lm_fdr_e_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_Hypo_diffBlur_noAmyloidosis/',i,'_lm_fdr_e_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_e{1,1});
    ...
    for i = {'blAV45', 'emciblAV45', 'lmciblAV45', 'adblAV45'}
          ...
          s_t = strcat('writeToFile(tVals_',i,'_fdr'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_Hypo_diffBlur_noAmyloidosis/',i,'_lm_fdr_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_Hypo_diffBlur_noAmyloidosis/',i,'_lm_fdr_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t{1,1});
    ...
    for i = {'blAV45', 'emciblAV45', 'lmciblAV45', 'adblAV45'}
          ...
          s_t_f = strcat('writeToFile(tVals_',i,''', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_Hypo_diffBlur_noAmyloidosis/',i,'_lm_full_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/Int_diagnosis_Hypo_diffBlur_noAmyloidosis/',i,'_lm_full_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t_f{1,1});
