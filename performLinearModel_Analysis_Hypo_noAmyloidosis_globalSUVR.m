...
if (run_cn)
    ...
    cn_av45_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/cn_av45_bl_globalSUVR_pvcd.csv';
    cn_av45_bl_d = textscan(fopen(cn_av45_bl_file), '%d,%f');
    cn_av45_bl_data = cn_av45_bl_d{1,2};
    
    cn_av45_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/cn_av45_fu_globalSUVR_pvcd.csv';
    cn_av45_fu_d = textscan(fopen(cn_av45_fu_file), '%d,%f');
    cn_av45_fu_data = cn_av45_fu_d{1,2};
    
    cn_fdg_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/cn_fdg_bl_globalSUVR_pvcd.csv';
    cn_fdg_bl_d = textscan(fopen(cn_fdg_bl_file), '%d,%f');
    cn_fdg_bl_data = cn_fdg_bl_d{1,2};
    
    cn_fdg_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/cn_fdg_fu_globalSUVR_pvcd.csv';
    cn_fdg_fu_d = textscan(fopen(cn_fdg_fu_file), '%d,%f');
    cn_fdg_fu_data = cn_fdg_fu_d{1,2};
...
if (run_emci)
    ...
    emci_av45_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/emci_av45_bl_globalSUVR_pvcd.csv';
    emci_av45_bl_d = textscan(fopen(emci_av45_bl_file), '%d,%f');
    emci_av45_bl_data = emci_av45_bl_d{1,2};
    
    emci_av45_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/emci_av45_fu_globalSUVR_pvcd.csv';
    emci_av45_fu_d = textscan(fopen(emci_av45_fu_file), '%d,%f');
    emci_av45_fu_data = emci_av45_fu_d{1,2};
    
    emci_fdg_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/emci_fdg_bl_globalSUVR_pvcd.csv';
    emci_fdg_bl_d = textscan(fopen(emci_fdg_bl_file), '%d,%f');
    emci_fdg_bl_data = emci_fdg_bl_d{1,2};
    
    emci_fdg_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/emci_fdg_fu_globalSUVR_pvcd.csv';
    emci_fdg_fu_d = textscan(fopen(emci_fdg_fu_file), '%d,%f');
    emci_fdg_fu_data = emci_fdg_fu_d{1,2};
...
if (run_lmci)
    ...
    lmci_av45_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/lmci_av45_bl_globalSUVR_pvcd.csv';
    lmci_av45_bl_d = textscan(fopen(lmci_av45_bl_file), '%d,%f');
    lmci_av45_bl_data = lmci_av45_bl_d{1,2};
    
    lmci_av45_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/lmci_av45_fu_globalSUVR_pvcd.csv';
    lmci_av45_fu_d = textscan(fopen(lmci_av45_fu_file), '%d,%f');
    lmci_av45_fu_data = lmci_av45_fu_d{1,2};
    
    lmci_fdg_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/lmci_fdg_bl_globalSUVR_pvcd.csv';
    lmci_fdg_bl_d = textscan(fopen(lmci_fdg_bl_file), '%d,%f');
    lmci_fdg_bl_data = lmci_fdg_bl_d{1,2};
    
    lmci_fdg_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/lmci_fdg_fu_globalSUVR_pvcd.csv';
    lmci_fdg_fu_d = textscan(fopen(lmci_fdg_fu_file), '%d,%f');
    lmci_fdg_fu_data = lmci_fdg_fu_d{1,2};
end
...
if (run_ad)
    ...
    ad_av45_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/ad_av45_bl_globalSUVR_pvcd.csv';
    ad_av45_bl_d = textscan(fopen(ad_av45_bl_file), '%d,%f');
    ad_av45_bl_data = ad_av45_bl_d{1,2};
    
    ad_av45_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/ad_av45_fu_globalSUVR_pvcd.csv';
    ad_av45_fu_d = textscan(fopen(ad_av45_fu_file), '%d,%f');
    ad_av45_fu_data = ad_av45_fu_d{1,2};
    
    ad_fdg_bl_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/ad_fdg_bl_globalSUVR_pvcd.csv';
    ad_fdg_bl_d = textscan(fopen(ad_fdg_bl_file), '%d,%f');
    ad_fdg_bl_data = ad_fdg_bl_d{1,2};
    
    ad_fdg_fu_file = '/data/data03/sulantha/VertstatsFiles_Network_Analsis/Subject_meta/ad_fdg_fu_globalSUVR_pvcd.csv';
    ad_fdg_fu_d = textscan(fopen(ad_fdg_fu_file), '%d,%f');
    ad_fdg_fu_data = ad_fdg_fu_d{1,2};
end
...
if (run_analysis)
    ...
    parfor k = 1:2000
        cn_full_XMat = [cn_fdg_bl_data cn_av45_bl_data cn_age_data cn_gender_data cn_apoe4_data];
        cn_full_lm = LinearModel.fit(cn_full_XMat, cn_full_fdg_Yearlyhypomet(:,k), 'CategoricalVars', [4,5]);
    ...
    parfor k = 1:2000
        emci_full_XMat = [emci_fdg_bl_data emci_av45_bl_data emci_age_data emci_gender_data emci_apoe4_data];
        emci_full_lm = LinearModel.fit(emci_full_XMat, emci_full_fdg_Yearlyhypomet(:,k), 'CategoricalVars', [4,5]);
    ...
    parfor k = 1:2000
        lmci_full_XMat = [lmci_fdg_bl_data lmci_av45_bl_data lmci_age_data lmci_gender_data lmci_apoe4_data];
        lmci_full_lm = LinearModel.fit(lmci_full_XMat, lmci_full_fdg_Yearlyhypomet(:,k), 'CategoricalVars', [4,5]);
    ...
    parfor k = 1:2000
        ad_full_XMat = [ad_fdg_bl_data ad_av45_bl_data ad_age_data ad_gender_data ad_apoe4_data];
        ad_full_lm = LinearModel.fit(ad_full_XMat, ad_full_fdg_Yearlyhypomet(:,k), 'CategoricalVars', [4,5]);
...
if (run_checkcorr)
    ...
    cn_avbl_fdgbl_corrVal = zeros(1,2000);
    cn_avbl_fdgbl_corrValp = ones(1,2000);
    for k=1:2000
        [cn_avbl_fdgbl_corrVal(k), cn_avbl_fdgbl_corrValp(k)] = corr(cn_full_fdg_bl_avgMat(:,k),cn_full_av45_bl_avgMat(:,k));
    end
    
    emci_avbl_fdgbl_corrVal = zeros(1,2000);
    emci_avbl_fdgbl_corrValp = ones(1,2000);
    for k=1:2000
        [emci_avbl_fdgbl_corrVal(k), emci_avbl_fdgbl_corrValp(k)] = corr(emci_full_fdg_bl_avgMat(:,k),emci_full_av45_bl_avgMat(:,k));
    end
    
    lmci_avbl_fdgbl_corrVal = zeros(1,2000);
    lmci_avbl_fdgbl_corrValp = ones(1,2000);
    for k=1:2000
        [lmci_avbl_fdgbl_corrVal(k), lmci_avbl_fdgbl_corrValp(k)] = corr(lmci_full_fdg_bl_avgMat(:,k),lmci_full_av45_bl_avgMat(:,k));
    end
    
    ad_avbl_fdgbl_corrVal = zeros(1,2000);
    ad_avbl_fdgbl_corrValp = ones(1,2000);
    for k=1:2000
        [ad_avbl_fdgbl_corrVal(k), ad_avbl_fdgbl_corrValp(k)] = corr(ad_full_fdg_bl_avgMat(:,k),ad_full_av45_bl_avgMat(:,k));
    end
...
if (get_meanHypomet)
    writeToFile(mean(cn_full_fdg_Yearlyhypomet), '/data/data03/sulantha/linear_model_feb2015/Mean_Yearlyhypomet/cn_meanHypomet_l.txt', '/data/data03/sulantha/linear_model_feb2015/Mean_Yearlyhypomet/cn_meanHypomet_r.txt',l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);
    writeToFile(mean(emci_full_fdg_Yearlyhypomet), '/data/data03/sulantha/linear_model_feb2015/Mean_Yearlyhypomet/emci_meanHypomet_l.txt', '/data/data03/sulantha/linear_model_feb2015/Mean_Yearlyhypomet/emci_meanHypomet_r.txt',l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);
    writeToFile(mean(lmci_full_fdg_Yearlyhypomet), '/data/data03/sulantha/linear_model_feb2015/Mean_Yearlyhypomet/lmci_meanHypomet_l.txt', '/data/data03/sulantha/linear_model_feb2015/Mean_Yearlyhypomet/lmci_meanHypomet_r.txt',l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData)
    writeToFile(mean(ad_full_fdg_Yearlyhypomet), '/data/data03/sulantha/linear_model_feb2015/Mean_Yearlyhypomet/ad_meanHypomet_l.txt', '/data/data03/sulantha/linear_model_feb2015/Mean_Yearlyhypomet/ad_meanHypomet_r.txt',l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);

end

if (get_meanAmyloidosis)
    writeToFile(mean(cn_full_av45_amylodosis), '/data/data03/sulantha/linear_model_feb2015/Mean_Amyloidosis/cn_meanAmyloidosis_l.txt', '/data/data03/sulantha/linear_model_feb2015/Mean_Amyloidosis/cn_meanAmyloidosis_r.txt',l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);
    writeToFile(mean(emci_full_av45_amylodosis), '/data/data03/sulantha/linear_model_feb2015/Mean_Amyloidosis/emci_meanAmyloidosis_l.txt', '/data/data03/sulantha/linear_model_feb2015/Mean_Amyloidosis/emci_meanAmyloidosis_r.txt',l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);
    writeToFile(mean(lmci_full_av45_amylodosis), '/data/data03/sulantha/linear_model_feb2015/Mean_Amyloidosis/lmci_meanAmyloidosis_l.txt', '/data/data03/sulantha/linear_model_feb2015/Mean_Amyloidosis/lmci_meanAmyloidosis_r.txt',l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData)
    writeToFile(mean(ad_full_av45_amylodosis), '/data/data03/sulantha/linear_model_feb2015/Mean_Amyloidosis/ad_meanAmyloidosis_l.txt', '/data/data03/sulantha/linear_model_feb2015/Mean_Amyloidosis/ad_meanAmyloidosis_r.txt',l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);
...
if (run_writeStats)
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'blFDG' , 'blAV45' , 'age' , 'gender' , 'apoe4'}
          s_e = strcat('writeToFile(',i,'_full_lm_',j,'_e_list_fdr, ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_fdr_e_l.txt'', ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_fdr_e_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_e{1,1});
       end
    end
    ...
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'blFDG' , 'blAV45' , 'age' , 'gender' , 'apoe4'}
          s_t = strcat('writeToFile(',i,'_full_lm_',j,'_t_list_fdr, ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_fdr_t_l.txt'', ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_fdr_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t{1,1});
       end
    end
    ...
    for i = {'cn', 'emci', 'lmci', 'ad'}
       for j = {'blFDG' , 'blAV45' , 'age' , 'gender' , 'apoe4'}
          s_t_f = strcat('writeToFile(',i,'_full_lm_',j,'_t_list, ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_full_t_l.txt'', ''/data/data03/sulantha/linear_model_feb2015/Wo_Int_Hypo_diffBlur_noAmyloidosis_globalSUVR/',i,'_lm_',j,'_full_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t_f{1,1});
       end
    end
end
