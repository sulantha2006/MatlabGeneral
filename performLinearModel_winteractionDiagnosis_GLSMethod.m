...
if (get_values)
    pVals = csvread('/home/sulantha/Desktop/GLSMethodTempFiles/p_table.csv',0,0);
    tVals = csvread('/home/sulantha/Desktop/GLSMethodTempFiles/t_table.csv',0,0);
    eVals = csvread('/home/sulantha/Desktop/GLSMethodTempFiles/e_table.csv',0,0);
    
    pVals_av45 = pVals(:,5);
    pVals_emciav45 = pVals(:,9);
    pVals_lmciav45 = pVals(:,10);
    pVals_adav45 = pVals(:,11);
    
    tVals_av45 = tVals(:,5);
    tVals_emciav45 = tVals(:,9);
    tVals_lmciav45 = tVals(:,10);
    tVals_adav45 = tVals(:,11);
    
    eVals_av45 = eVals(:,5);
    eVals_emciav45 = eVals(:,9);
    eVals_lmciav45 = eVals(:,10);
    eVals_adav45 = eVals(:,11);
end

if (run_fdr)
    pVals_av45_fdr = fdr_bh(pVals_av45, 0.1);
...
if (get_estimates)
    eVals_av45_fdr = eVals_av45 .* pVals_av45_fdr;
...
if (get_tstats_fdr)
    tVals_av45_fdr = tVals_av45 .* pVals_av45_fdr;
...
if (run_writeStats)
    for i = {'av45', 'emciav45', 'lmciav45', 'adav45'}
       
          s_e = strcat('writeToFile(eVals_',i,'_fdr'', ''/home/sulantha/Desktop/linear_model_sept2014/gls_model_diffBlur/',i,'_lm_fdr_e_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/gls_model_diffBlur/',i,'_lm_fdr_e_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_e{1,1});
    ...
    for i = {'av45', 'emciav45', 'lmciav45', 'adav45'}
          ...
          s_t = strcat('writeToFile(tVals_',i,'_fdr'', ''/home/sulantha/Desktop/linear_model_sept2014/gls_model_diffBlur/',i,'_lm_fdr_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/gls_model_diffBlur/',i,'_lm_fdr_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t{1,1});
    ...
    for i = {'av45', 'emciav45', 'lmciav45', 'adav45'}
          ...
          s_t_f = strcat('writeToFile(tVals_',i,''', ''/home/sulantha/Desktop/linear_model_sept2014/gls_model_diffBlur/',i,'_lm_full_t_l.txt'', ''/home/sulantha/Desktop/linear_model_sept2014/gls_model_diffBlur/',i,'_lm_full_t_r.txt'', l_map_dToS, r_map_dToS, l_map_SpacialToData, r_map_SpacialToData);');
          eval(s_t_f{1,1});
